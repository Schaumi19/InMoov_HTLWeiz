...
# Rock Paper Scissors gestures
    ...
    def demonstration(self):
        self.right_shoulder(0, 30)
        self.right_hand_fingers(0, 0)
        self.right_hand_rotate(20)
        self.left_shoulder(0, 120)
        self.left_hand_fingers(0, 180)
        self.left_hand_rotate(150)
        self.torso(2, 30)
        self.head(0, 100)
        time.sleep(5)
        self.head(0, 70)
        ...
        time.sleep(5)
        self.head(0, 70)
        self.right_shoulder(0, 130)
        self.right_hand_fingers(0, 180)
        self.right_hand_rotate(120)
        self.left_shoulder(0, 30)
        self.left_hand_fingers(0, 0)
        self.left_hand_rotate(20)
        self.torso(2, 130)
        time.sleep(5)
        self.head(0, 100)
        time.sleep(5)
