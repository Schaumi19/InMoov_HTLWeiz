...
from .optimizer import ConjugateGradientOptimizer #optimizer test
from .optimizer import ScipySmoothOptimizer #optimizer test
...
class Actuator(object):
    ...
    def __init__(self, tokens, optimizer=None):
        ...
        self.ik = IKSolver(
            ...
            #self.fk, ConjugateGradientOptimizer() if optimizer is None else optimizer)
            ##self.fk, ScipySmoothOptimizer() if optimizer is None else optimizer)
